...
public class ImmersiveAudioSource : MonoBehaviour
{
	...
	private void UpdateAudio(bool snap)
	{
		...
		{
			lowPassFilter.cutoffFrequency = Mathf.Pow(10, Mathf.Lerp(Mathf.Log10(lowPassFilter.cutoffFrequency), Math.MapClamped(distance, 0, 100, Mathf.Log10(20000), Mathf.Log10(200)), deltaTime * 5));
